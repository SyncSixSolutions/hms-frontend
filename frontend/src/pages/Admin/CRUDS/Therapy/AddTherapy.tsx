...
import { Calendar, Plus, ImageIcon, Info } from 'lucide-react';
            ...
            <div className="mb-8">
              ...
              <div className="flex gap-4 flex-wrap">
                ...
                {defaultImages.map((img, index) => (
                  <div key={index} className="w-36 h-28 rounded-lg overflow-hidden bg-gray-200">
                    <img 
                      src={img} 
                      alt={`Therapy ${index + 1}`}
                ...
                {selectedImages.map((img, index) => (
                  <div key={`selected-${index}`} className="w-36 h-28 rounded-lg overflow-hidden bg-gray-200">
                    <img 
                      src={img} 
